...
const { getCheckoutProduct, getCheckoutProductByPriceId } = require('./paymentPlans');
...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    ...
    const product = getCheckoutProduct(data?.planId) || getCheckoutProductByPriceId(data?.priceId);
