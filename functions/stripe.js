...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    ...
    const checkoutItem = resolveCheckoutItem(planId);
    ...
    try {
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            metadata: {
                ...
                purchaseType: checkoutItem.purchaseType || 'subscription',
                credits: checkoutItem.credits ? String(checkoutItem.credits) : ''
            }
        });
