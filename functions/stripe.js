...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    ...
    const requestedPlanId = data?.planId || data?.packageId;
    ...
    try {
        ...
        if (plan.subscriptionTier) metadata.subscriptionTier = plan.subscriptionTier;
        if (plan.privateCredits) metadata.privateCredits = String(plan.privateCredits);
        if (plan.offerCredits) metadata.offerCredits = String(plan.offerCredits);
