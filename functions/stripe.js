...
const { getPaymentCatalogItem } = require('./paymentPlans');
...
exports.createCheckoutSession = functions.https.onCall(async (data, context) => {
    ...
    const plan = getPaymentCatalogItem(planId);
    ...
    try {
        ...
        const sessionMetadata = {
            ...
            tier: plan.tier || '',
            purchasedPrivateCredits: String(plan.purchasedPrivateCredits || 0),
            offerSlotCredits: String(plan.offerSlotCredits || 0),
        };
        ...
        const session = await stripe.checkout.sessions.create({
            ...
            ...(plan.kind === 'subscription' ? { subscription_data: { metadata: sessionMetadata } } : {}),
        });
