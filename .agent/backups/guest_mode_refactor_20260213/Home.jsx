                ...
                <div style={{
                    ...
                    <div style={{ position: 'relative', zIndex: 1 }}>
                        <h3 style={{
                            ...
                            {t('welcome_guest', { defaultValue: '👋 Welcome to DineBuddies!' })}
                        </h3>
                        <p style={{
                            ...
                            {t('guest_banner_subtitle', { defaultValue: 'Join our community to create invitations, connect with food lovers, and discover amazing dining experiences!' })}
                        </p>
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div>
                                            ...
                                            {/* Create Invitation Button - Only for non-business users */}
