...
/** Icon-only promo picker (canvas stickers still use display labels). */import { AppText } from "../../../components/base";
...
function ColorRow({ label, colors, value, onChange }) {
  return (
    <div className="sps-color-row">
            <AppText as="span" className="sps-color-row__label">{label}</AppText>
            ...
            <div className="sps-align-panel__body">
                <div className="sps-align-panel__row">
                    <div className="sps-align-panel__col">
                        <AppText as="p" className="sps-glass-sub">{t('studio_align_h')}</AppText>
              ...
              <button
                ...
                onClick={() => setStyle((s) => ({ ...s, textAlign: id }))}>
                    ...
                    <div className="sps-align-panel__col">
                        <AppText as="p" className="sps-glass-sub">{t('studio_align_v')}</AppText>
                        <div className="sps-glass-tools">
                ...
                <div className="sps-align-panel__spacing">
                    <AppText as="p" className="sps-glass-sub">{t('studio_text_spacing')}</AppText>
                    <StudioStepperRow
      ...
      className={`sps-fx-cell${active ? ' is-on' : ''}${isColorTarget ? ' is-target' : ''}`}>
        ...
        onClick={() => {
          ...
          if (!active) onToggle(true);
                ...
                <AppText as="span" className="sps-fx-toggle__label">{label}</AppText>
            </button>
        </div>);
...
export function StudioEffectsPanel({ style, setStyle, t }) {
  ...
  return (
    <div className="sps-glass-panel sps-glass-panel--compact sps-effects-panel">
            <AppText as="p" className="sps-glass-sub">
                {t('studio_fx_pick')}
            </AppText>
...
export function StudioPromoPanel({ onInsertSticker, stickerCount = 0, t }) {
  ...
  return (
    <div className="sps-glass-panel sps-glass-panel--promo sps-promo-panel">
            <AppText as="p" className="sps-glass-sub">{t('studio_promo_pick')}</AppText>
    ...
    <div className="sps-glass-panel sps-glass-panel--compact">
      ...
      <button
        ...
        onClick={() => onSelectLayer(layer.id)}>
                    ...
                    <AppText as="span" className="sps-layer-row__icon" aria-hidden />
                    {layer.label}
                </button>
      )}
        </div>);
