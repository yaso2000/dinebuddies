  ...
  return (
    <div style={{ position: 'relative', borderRadius: 12, overflow: 'hidden', ...style }}>
        ...
        <>
            ...
            style={{
              ...
              animation: 'db-spin 0.85s linear infinite'
                        ...
                        <AppText as="span" style={{ fontSize: '0.9rem', fontWeight: 700 }}>
              ...
              style={{
                ...
                style={{
                  ...
                  transition: 'width 0.25s ease'
                                ...
                                <AppText as="span" style={{ fontSize: '0.82rem', fontWeight: 700, opacity: 0.95 }}>
                                    {displayProgress}%
                                </AppText>
                            </>
          }
        ...
        <>
                        ...
                        <AppText as="span" style={{ fontSize: '0.88rem', fontWeight: 800, lineHeight: 1.45, maxWidth: 280 }}>
                            {rejectionText}
                        </AppText>
                        <AppText as="span" style={{ fontSize: '0.78rem', opacity: 0.9 }}>
