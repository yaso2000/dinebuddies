...
export default function BusinessFeedbackInbox() {
  ...
  if (unresolvedFeedbacks.length === 0) {
    return (
      <div style={{ padding: '60px 20px', textAlign: 'center', background: 'var(--bg-card)', borderRadius: '16px', border: '1px dashed var(--border-color)' }}>
                ...
                <AppText as="h3" style={{ margin: '0 0 8px 0', color: 'var(--text-main)' }}>{t('feedback_empty_title', 'Inbox is Empty')}</AppText>
                <AppText as="p" style={{ color: 'var(--text-secondary)', margin: 0 }}>{t('feedback_empty_desc', 'You haven\'t received any new open complaints or suggestions.')}</AppText>
            </div>);
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
            ...
            <AppText as="h3" style={{ margin: '0 0 8px 0', fontSize: '1.05rem', color: 'var(--text-main)' }}>
            ...
            onMouseLeave={(e) => e.currentTarget.style.transform = 'none'}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '4px' }}>
                                ...
                                <AppText as="span" style={{ fontSize: '0.75rem', color: 'var(--text-muted)', whiteSpace: 'nowrap' }}>
                                    {dateStr}
                                </AppText>
                            </div>
                            
                            <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
                                <AppText as="span" style={{ marginRight: '6px', color: isSuggestion ? '#22c55e' : '#ef4444' }}>
        ...
        background: 'rgba(0,0,0,0.7)', backdropFilter: 'blur(5px)', padding: '16px'
          ...
          display: 'flex', flexDirection: 'column', overflow: 'hidden', boxShadow: '0 10px 40px rgba(0,0,0,0.3)'
                        ...
                        <div style={{ padding: '20px', borderBottom: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            <AppText as="h3" style={{ margin: 0, fontSize: '1.1rem', fontWeight: '800', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <AppText as="span" style={{ color: selectedFeedback.type === 'suggestion' ? '#22c55e' : '#ef4444' }}>
