        ...
        <div className={compact ? 'cm-panel cm-panel--compact' : 'cm-panel'}>
            <div style={{ marginBottom: '1.5rem' }}>
                ...
                <p style={{ margin: 0, color: 'var(--text-muted)', fontSize: '0.9rem', borderTop: '1px solid var(--border-color)', paddingTop: '0.75rem' }}>
                    {members.length} {t('members_count', 'members')} • <span style={{ color: 'var(--primary-color)', fontWeight: 'bold' }}>{selectedMembers.length} {t('selected_count', 'selected')}</span>
                </p>
            </div>
                    ...
                    {members.map(member => (
                        ...
                        >
                            ...
                            <div className="cm-member-info">
                                <h4 className="cm-member-name">{member.name}</h4>
                                {member.isMuted && (
