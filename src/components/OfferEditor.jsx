...
const OfferEditor = ({ onPublish, businessProfile, initialData = null }) => {
  ...
  return (
    <div className="editor-wrapper">
            <AppText as="h2" className="editor-title">{t('create_special_offer', 'Create Special Offer')}</AppText>

            {/* Preview Section - Dynamic Luxury Styles */}
            <div className="preview-section">
                <AppText as="p" className="label">{t('banner_preview_label', 'Banner Preview:')}</AppText>
              ...
              '📷'}
                    ...
                    <div className="offer-details">
                        <AppText as="h3">{offerData.title || t('offer_title_placeholder_preview', "Offer Title here...")}</AppText>
                        <AppText as="p">{offerData.description || t('offer_desc_placeholder_preview', "Short description will appear here...")}</AppText>
                    </div>
            ...
            <img
              ...
              className="business-logo-mini" />
                        ...
                        <AppText as="span" className="business-name-mini">
                            {offerData.identityType === 'badge' ?
            ...
            <div
              ...
              onChange={(e) => setOfferData({
                ...
                visual: { ...offerData.visual, isGlass: e.target.checked }
                        ...
                        <AppText as="span">{t('glass_effect_toggle', 'Glassmorphism')}</AppText>
                    </label>
              ...
              onChange={(e) => setOfferData({
                ...
                visual: { ...offerData.visual, hasShimmer: e.target.checked }
                        ...
                        <AppText as="span">{t('shimmer_effect_toggle', 'Animated Shimmer')}</AppText>
                    </label>
                </div>
          ...
          style={{ width: '100%', marginBottom: 0 }} />
                    ...
                    <AppText as="span" style={{ position: 'absolute', bottom: '10px', right: '10px', fontSize: '0.75rem', color: (offerData.description?.length || 0) >= 100 ? 'var(--secondary)' : 'var(--text-muted)' }}>
