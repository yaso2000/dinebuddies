    ...
    return (
        ...
        >
            {!pinned ? (
                ...
                >
                    <FaBookmark />
                    <span>{t('notification_toast_keep', 'Keep')}</span>
                </div>
            ) : null}
            <div
            ...
            >
                ...
                <div className="notification-toast__copy">
                    <h4 className="notification-toast__title">
                        {pinned ? (
                            <span className="notification-toast__saved-badge">
                                {t('notification_toast_saved', 'Saved')}
                            </span>
                        ) : null}
                        {message.title || t('new_notification', 'New Notification')}
                    </h4>
                    <p className="notification-toast__body">{message.body || message.text}</p>
                    {!pinned ? (
                        <p className="notification-toast__hint">
