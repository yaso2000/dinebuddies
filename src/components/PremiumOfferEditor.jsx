              ...
              <button
                ...
                style={{
                  ...
                  color: pair.h === offerData.headerFontFamily && pair.b === offerData.bodyFontFamily ? '#D4AF37' : 'var(--text-muted)'
                                    ...
                                    <AppText as="span" style={{ fontWeight: 'bold' }}>{pair.name}</AppText>
                                    <AppText as="span" style={{ fontSize: '0.6rem', opacity: 0.7 }}>Heading + Body</AppText>
                                </button>
              )}
                        </div>
              ...
              placeholder="e.g. 50% Off Signature Dish" />
                        ...
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '4px' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flex: 1 }}>
                                <AppText as="span" style={{ fontSize: '0.7rem', color: 'var(--text-muted)' }}>Font Size</AppText>
                                <input
                  type="range"
                  min="0.8"
                  max="2.5"
                  ...
                  style={{ flex: 1, height: '4px', cursor: 'pointer', accentColor: '#D4AF37' }} />
                                ...
                                <AppText as="span" style={{ fontSize: '0.7rem', color: '#D4AF37', fontWeight: 'bold', minWidth: '30px' }}>
                ...
                onChange={(e) => {
                  ...
                  if (file) {
                    ...
                    setOfferData({ ...offerData, imageUrl: previewUrl, file });
                            ...
                            <AppText as="span" style={{ textAlign: 'center' }}>
                                {offerData.file ?
                <AppText as="span" style={{ color: '#D4AF37', fontWeight: 'bold' }}>✓ {offerData.file.name}</AppText> :
                <AppText as="span">Click here to select a <b>high-resolution</b> image</AppText>
                }
                            </AppText>
                        </label>
                    </div>
