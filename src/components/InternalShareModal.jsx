      ...
      padding: '20px'
        ...
        maxHeight: '85vh', boxShadow: '0 10px 40px rgba(0,0,0,0.5)'
                ...
                <div style={{ padding: '16px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '1px solid var(--border-color)' }}>
                    <AppText as="h3" style={{ margin: 0, fontSize: '1.2rem', color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '8px' }}>
          ...
          <>
            ...
            <AppText as="p" style={{ textAlign: 'center', padding: '20px', color: 'var(--text-muted)' }}>{t('no_chats_found', 'No recent chats found.')}</AppText> :
              ...
              return (
                <div key={convo.id} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '10px 12px', borderRadius: '8px', marginBottom: '4px', background: 'rgba(255,255,255,0.02)' }}>
                                            ...
                                            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                                                <AppText as="h4" style={{ margin: 0, fontSize: '0.95rem', color: 'var(--text-main)', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>{otherUser.displayName}</AppText>
                                            </div>
                                            <button
          ...
          <>
                            {loadingCommunities ?
            <AppText as="p" style={{ textAlign: 'center', padding: '20px', color: 'var(--text-muted)' }}>{t('loading', 'Loading...')}</AppText> :
            filteredCommunities.length === 0 ?
            <AppText as="p" style={{ textAlign: 'center', padding: '20px', color: 'var(--text-muted)' }}>{t('no_communities_found', 'No communities found.')}</AppText> :
            ...
            filteredCommunities.map((comm) => {
              ...
              return (
                <div key={comm.id} style={{ display: 'flex', alignItems: 'center', gap: '14px', padding: '10px 12px', borderRadius: '8px', marginBottom: '4px', background: 'rgba(255,255,255,0.02)' }}>
                                            ...
                                            <div style={{ flex: 1, minWidth: 0, overflow: 'hidden' }}>
                                                <AppText as="h4" style={{ margin: 0, fontSize: '0.95rem', color: 'var(--text-main)', whiteSpace: 'nowrap', textOverflow: 'ellipsis', overflow: 'hidden' }}>{comm.businessName || comm.display_name}</AppText>
                                                <AppText as="p" style={{ margin: 0, fontSize: '0.75rem', color: 'var(--text-muted)' }}>Community</AppText>
                                            </div>
                                            <button
