  ...
  return (
    <AnimatePresence>
      ...
      <>
          ...
          role="dialog"
          aria-modal="true"
          aria-label={t('discovery_icebreaker_menu_aria', 'Icebreaker menu')}
          ...
          onDragEnd={(_, info) => {
                        ...
                        <div className="discovery-sheet__header">
                            <div>
                                <AppText as="p" style={{ margin: 0, fontSize: '0.7rem', opacity: 0.55, fontWeight: 600 }}>
                                    {t('discovery_icebreaker_label', 'Icebreaker')}
                                </AppText>
                                <AppText as="h3" style={{ margin: '0.2rem 0 0', fontSize: '1.1rem', fontWeight: 800 }}>
                                    {profileName
                                      ? t('discovery_icebreaker_title_with_name', 'Say hi to {{name}}', { name: profileName })
                                      : t('discovery_icebreaker_title_pick', 'Pick a greeting')}
                                </AppText>
                            </div>
            ...
            <button
              ...
              onClick={() => {
                onSelect?.({ ...item, label: t(item.labelKey) });
                onClose();
              }}>
                                    ...
                                    <AppText as="span" className="discovery-sheet__label">
                                      {t(item.labelKey)}
                                    </AppText>
                                </button>
            )}
