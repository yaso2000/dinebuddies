...
export const SOCIAL_CARD_FRAME_COLORS = [
    {
        id: 'gold',
        labelKey: 'social_card_frame_gold',
        defaultLabel: 'Gold',
    ...
    {
        id: 'rose',
        labelKey: 'social_card_frame_rose',
        defaultLabel: 'Rose',
    ...
    {
        id: 'silver',
        labelKey: 'social_card_frame_silver',
        defaultLabel: 'Silver',
    ...
    {
        id: 'cream',
        labelKey: 'social_card_frame_cream',
        defaultLabel: 'Cream',
    ...
    {
        id: 'emerald',
        labelKey: 'social_card_frame_emerald',
    ...
    {
        id: 'burgundy',
        labelKey: 'social_card_frame_burgundy',
    ...
    {
        id: 'navy',
        labelKey: 'social_card_frame_navy',
        defaultLabel: 'Navy',
    ...
    {
        id: 'white',
        labelKey: 'social_card_frame_white',
        defaultLabel: 'White',
...
export function getFrameColorById(id) {
    return SOCIAL_CARD_FRAME_COLORS.find((c) => c.id === id) || SOCIAL_CARD_FRAME_COLORS[0];
}
