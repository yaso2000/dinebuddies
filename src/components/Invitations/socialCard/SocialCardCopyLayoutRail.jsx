...
import './SocialCardCopyLayoutRail.css';
...
export default function PrivateCardCopyLayoutRail({
    ...
    const buttons = [
        ...
        },
        {
            key: 'wider',
            icon: FaPlus,
            label: t('social_card_copy_wider', { defaultValue: 'Wider text area' }),
            onClick: () => bumpWidth(1),
        ...
        },
        {
            key: 'narrower',
            icon: FaMinus,
            label: t('social_card_copy_narrower', { defaultValue: 'Narrower text area' }),
            onClick: () => bumpWidth(-1),
    ...
    return (
        <div
            ...
            role="group"
            aria-label={t('social_card_copy_layout_label', { defaultValue: 'Text position and width' })}
        >
