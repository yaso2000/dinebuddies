...
import './SocialInvitationAiCoverPanel.css';

/**
 * Floating AI cover generator for private / private invite editors.
...
export default function SocialInvitationAiCoverPanel({
  open,
  onClose,
  subType = 'private',
  buildBrief,
  ...
  const resolvePreview = useCallback(
    async (url, seq) => {
      ...
      try {
        ...
        console.error('[SocialInvitationAiCoverPanel] preview resolve failed:', err);
        if (seq === previewSeqRef.current) {
          setPreviewRemoteUrl(null);
          showToast(
  ...
  <div className="ai-floating-sheet__backdrop" role="presentation" onClick={close}>
      ...
      onClick={(e) => e.stopPropagation()}>
                ...
                <header className="ai-floating-sheet__header">
                    <AppText as="h2" id="private-ai-cover-sheet-title" className="ai-floating-sheet__title">
                        <FaMagic aria-hidden />
        ...
        <div className="private-ai-cover-sheet__review">
                            <AppText as="p" className="private-ai-cover-sheet__review-label">
            ...
            <div className="private-ai-cover-sheet__preview-loading" aria-busy="true">
                                        ...
                                        <AppText as="span">{t('ai_generate_loading')}</AppText>
                                    </div> :
            previewDisplayUrl ?
            <img
          ...
          <AppText as="p" className="private-ai-cover-sheet__review-hint">
          ...
          null}
              ...
              disabled={previewLoading || !previewDisplayUrl}>
                                    ...
                                    <FaCheck aria-hidden />
                                    {t('social_cover_ai_use_image', { defaultValue: 'Use as cover' })}
                                </button>
                                <button
              type="button"
              ...
              disabled={previewLoading}>
                                    ...
                                    <FaRedo aria-hidden />
                                    {t('social_cover_ai_retry', { defaultValue: 'Try again' })}
                                </button>
                                <button
              type="button"
