...
import './PrivateCardCopyFontScaleRail.css';
...
export default function PrivateCardCopyFontScaleRail({
    ...
    const buttons = [
        {
            key: 'larger',
            label: t('private_card_copy_font_larger', { defaultValue: 'Larger title and message' }),
            text: 'A+',
            onClick: () => bumpScale(1),
        ...
        {
            key: 'smaller',
            label: t('private_card_copy_font_smaller', { defaultValue: 'Smaller title and message' }),
            text: 'A−',
            onClick: () => bumpScale(-1),
    ...
    return (
        <div
            ...
            role="group"
            aria-label={t('private_card_copy_font_scale_label', { defaultValue: 'Title and message size' })}
        >
