...
import './PrivateInvitationEditorFooter.css';

/**
 * Editor actions: close, save draft, preview — shown together at the bottom of create flows.
 */
export default function PrivateInvitationEditorFooter({
    onClose,
    onSave,
    onPreview,
    busy = false,
    ...
    return (
        <div
            className={`private-invitation-editor-footer${isDating ? ' private-invitation-editor-footer--dating' : ''}`}
        >
            <button
                type="button"
