...
const InvitationCard = ({ invitation }) => {
    ...
    const glassRow = (icon, label, withBorder = true) => (
        ...
        >
            <span style={{ width: 22, display: 'flex', justifyContent: 'center', opacity: 0.95 }}>{icon}</span>
    ...
    const splitMetaRow = (icon, label, withBorder = true) => (
        ...
        >
            <span style={{ width: 22, display: 'flex', justifyContent: 'center', color: '#6b7280' }}>{icon}</span>
            <span style={{ flex: 1 }}>{label}</span>
        </div>
    );
        ...
        return (
            ...
            >
                <div style={{ position: 'relative', width: '100%', aspectRatio: '16 / 9', background: '#0b0b0b' }}>
                    ...
                    >
                        <span style={{ ...infoPill, background: 'rgba(0,0,0,0.45)', color: '#fff', border: '1px solid rgba(255,255,255,0.25)' }}>
                    ...
                    <div style={{
                        ...
                        <div style={{ color: '#fff', display: 'flex', flexDirection: 'column', gap: 8 }}>
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8, alignItems: 'center' }}>
                                <span style={bottomMetaPillStyle}>
                    ...
                    <div style={{ padding: '8px 16px 16px' }}>
                        <div style={{
                            ...
                            <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                                ...
                                <span style={{ ...bottomMetaPillStyle, maxWidth: '100%' }}>
                                    <FaMapMarkerAlt style={{ opacity: 0.92 }} />
                ...
                {isPhotoChips && (
                    <div style={{ padding: '8px 16px 16px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 10 }}>
                        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 8 }}>
                            <span style={chipStyle}><FaCalendarAlt style={{ marginRight: 6, opacity: 0.9 }} />{formatInviteDate()}</span>
                            <span style={chipStyle}><FaClock style={{ marginRight: 6, opacity: 0.9 }} />{formatInviteTime() || '—'}</span>
                        </div>
                        <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', gap: 8 }}>
                            <span style={chipStyle}><FaUserFriends style={{ marginRight: 6, opacity: 0.9 }} />{guestsMeta}</span>
                            <span style={chipStyle}><FaMoneyBillWave style={{ marginRight: 6, opacity: 0.9 }} />{paymentLabel}</span>
                        </div>
                        {(distanceMeta || location) && (
                            <span style={chipStyle}><FaMapMarkerAlt style={{ marginRight: 6, opacity: 0.9 }} />{distanceMeta || location}</span>
                        )}
