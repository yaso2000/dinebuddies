          ...
          'var(--bg-body)'
              ...
              style={{
                ...
                color: '#f59e0b'
                        ...
                        <AppText as="p" style={{ margin: '6px 0 0', fontSize: '0.8rem', color: 'var(--text-muted)', lineHeight: 1.45 }}>
                            {canBroadcast ?
              t(
            ...
            <AppText as="p" style={{ margin: '8px 0 0', fontSize: '0.75rem', color: 'var(--primary)', fontWeight: '600' }}>
