      ...
      style={{
        ...
        style={{
          ...
          textAlign: 'center'
                ...
                <AppText as="h2" style={{ margin: '0 0 10px', fontSize: '1.2rem', fontWeight: 800 }}>
                    {t(titleKey, titleDefault)}
                </AppText>
                <AppText as="p" style={{ margin: '0 0 20px', fontSize: '0.92rem', color: 'var(--text-muted)', lineHeight: 1.55 }}>
