...
export default function BusinessLocationMap({
  ...
  country,
  height = '320px',
  /** When false: preview-only map — no external Maps links or map interaction. */
    ...
    <div
      style={{
        ...
        textAlign: 'center'
            ...
            <AppText as="span" style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>
