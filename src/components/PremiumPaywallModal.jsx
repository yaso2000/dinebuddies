        ...
        animation: 'slideUp 0.3s ease-out'
          ...
          padding: '30px 20px', textAlign: 'center', position: 'relative'
            ...
            boxShadow: '0 10px 25px rgba(0,0,0,0.2)'
                    ...
                    <AppText as="h2" style={{ color: '#fff', fontSize: '1.4rem', fontWeight: '800', margin: '0 0 5px' }}>
                        Unlock {featureName}
                    </AppText>
                    <AppText as="p" style={{ color: 'rgba(255,255,255,0.9)', fontSize: '0.9rem', margin: 0, fontWeight: 500 }}>
            ...
            <div key={i} style={{ display: 'flex', gap: '12px', alignItems: 'center' }}>
                ...
                display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0
                                ...
                                <AppText as="span" style={{ color: '#e2e8f0', fontSize: '0.9rem', fontWeight: 500 }}>{feat.text}</AppText>
                            </div>
            )}
                    </div>
