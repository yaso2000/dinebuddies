  ...
  return (
    <div
      ...
      <div className="image-caption" style={{ color: 'var(--brand-primary)', zIndex: 4 }}>
        ...
        <AppText as="p" onClick={() => isEditMode && setCaptionEdit(actualIndex)}>{image.caption}</AppText>
        }
                </div>
      }
            {isEditMode &&
  ...
  return (
    <div className="enhanced-gallery-section" style={{ background: 'var(--bg-card)', position: 'relative' }}>
            ...
            <div className="gallery-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                <AppText as="h3" style={{ color: 'var(--text-main)', textShadow: 'none', margin: 0, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <FaImages style={{ color: 'var(--brand-primary)' }} />
                    <AppText as="span">{t('gallery', 'Gallery')}</AppText>
      ...
      <div className="upload-section">
                    <div className="upload-hint">
                        ...
                        <AppText as="span">{t('add_images_above', 'Add images by category:')}</AppText>
                        {gallery.length >= MAX_IMAGES &&
          <AppText as="span" className="upload-limit-hint" style={{ marginLeft: '0.5rem', opacity: 0.85, fontSize: '0.85rem' }}>
            ...
            return (
              <label
                ...
                title={atLimit ? t('gallery_max_reached', `Max ${MAX_IMAGES} images`) : `${t('add', 'Add')} ${t(cat.id, cat.label)}`}>
                                    ...
                                    <AppText as="span" className="upload-label">{t(cat.id, cat.label)}</AppText>
                                    <input
                  type="file"
                  accept="image/*"
      ...
      <div className="gallery-empty">
                    ...
                    <AppText as="p">{t('no_images', 'No images yet')}</AppText>
                    {isEditMode &&
        <AppText as="p" style={{ fontSize: '0.85rem', opacity: 0.7 }}>
            ...
            return (
              <div
                ...
                <div className="image-caption" style={{ color: 'var(--brand-primary)', zIndex: 4 }}>
                  ...
                  <AppText as="p" onClick={() => isEditMode && setCaptionEdit(actualIndex)}>
                                                {image.caption}
                                            </AppText>
                  }
                                    </div>
