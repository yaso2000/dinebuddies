...
/**
 * PrivateInvitationSplash
 * 
 * Shown when the current user has a pending private invite.
 * Phase flow:
...
const PrivateInvitationSplash = ({ invitation, hostInfo, onView, onClose }) => {
      ...
      <div style={{
        ...
        gap: '1.2rem'
          ...
          textShadow: '0 2px 8px rgba(0,0,0,0.8)'
                        ...
                        {t('private_splash_tap_open', 'Tap to open your message ❤️')}
                    </AppText>
                </div>
      }
          ...
          animation: 'datingSplashSlideUp 0.5s cubic-bezier(0.22.1,0.36,1)'
            ...
            style={{
              ...
              lineHeight: 1.5
                                ...
                                {t('private_splash_sent_invite', 'sent you a private invite')}
                                {restaurantName ?
...
export default PrivateInvitationSplash;