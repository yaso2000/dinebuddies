      ...
      <div style={{ marginBottom: 16, position: 'relative' }}>
          ...
          style={{
            ...
            textDecoration: 'none'
                    ...
                    <AppText as="p" style={{ textAlign: 'center', color: 'rgba(255,255,255,0.35)', fontSize: '0.7rem', marginTop: 6 }}>
        ...
        <div key={p.name} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '6px' }}>
            ...
            onMouseLeave={(e) => {
              ...
              el.style.boxShadow = 'none';
                            ...
                            <AppText as="span" style={{ fontSize: '0.7rem', color: 'var(--text-main)', textAlign: 'center', maxWidth: '60px', lineHeight: '1.2' }}>{p.name}</AppText>
                        </div>
        )}
                </div>
      }
