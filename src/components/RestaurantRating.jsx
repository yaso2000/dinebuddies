  ...
  return (
    <div style={{ marginTop: '2rem' }}>
        ...
        marginBottom: '1.5rem'
                ...
                <AppText as="h3" style={{ fontSize: '1.2rem', fontWeight: '900', marginBottom: '1rem', display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              return (
                <div key={star} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.4rem' }}>
                                    <AppText as="span" style={{ fontSize: '0.85rem', width: '20px' }}>{star}⭐</AppText>
                      ...
                      transition: 'width 0.3s ease'
                                    ...
                                    <AppText as="span" style={{ fontSize: '0.8rem', color: 'var(--text-muted)', width: '30px', textAlign: 'right' }}>
                                        {count}
                                    </AppText>
                                </div>);
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        marginBottom: '1.5rem'
                    ...
                    <AppText as="h4" style={{ fontSize: '1rem', fontWeight: '800', marginBottom: '1rem' }}>
                        {t('add_your_review')}
                    </AppText>
              ...
              style={{ width: '45px', height: '45px', borderRadius: '50%', objectFit: 'cover' }} />
                                ...
                                <div style={{ flex: 1 }}>
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.25rem' }}>
                                        <AppText as="span" style={{ fontWeight: '700', fontSize: '0.95rem' }}>{review.userName}</AppText>
                                        <AppText as="span" style={{ fontSize: '0.75rem', color: 'var(--text-muted)' }}>
                ...
                <FaStar
                  ...
                  style={{
                    ...
                    color: star <= review.rating ? 'var(--luxury-gold)' : '#444'
                            ...
                            {review.comment &&
          <AppText as="p" style={{ fontSize: '0.9rem', lineHeight: '1.5', color: 'var(--text-secondary)', marginBottom: '0.75rem' }}>
                                    {review.comment}
                                </AppText>
          }
