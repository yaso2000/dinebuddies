...
/**
 * Cancelling a follow locks the action for a day, so a mis-tap is expensive. One
 * shared copy so every card and profile asks the same way, and says what it costs.
 *
