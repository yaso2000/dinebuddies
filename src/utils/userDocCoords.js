/**
 * Resolve lat/lng from users/{uid} documents — matches how the app stores location:
 * coordinates (AuthContext), GeoPoint-like location, signup userLat/userLng, businessInfo.
 */
...
/**
 * @param {Record<string, unknown>} u — raw Firestore user doc + id
 * @returns {{ lat: number, lng: number } | null}
 */
export function getUserDocLatLng(u) {
