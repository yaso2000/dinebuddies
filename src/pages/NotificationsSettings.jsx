...
import {
  ...
  getLastFcmRegistrationError } from
'../services/notificationService';
import { persistPushEnabledPref } from '../services/pushPrefs';
import {
  schedulePushRegistration,
  startBackgroundPushRegistration } from
'../services/pushRegistrationCoordinator';
    ...
    <div className="notification-settings-page">
        ...
        <div className="notification-settings-ios-hint" role="status">
                        ...
                        <div>
                            ...
                            <AppText as="p" style={{ margin: '6px 0 0', fontSize: '0.85rem', lineHeight: 1.45 }}>
                                {t(
                'ios_push_settings_hint',
        ...
        <div
          ...
          style={{ borderColor: 'rgba(239,68,68,0.4)' }}>
                ...
                <div className="settings-section">
                    <AppText as="h3" className="section-title">
            ...
            style={{
              ...
              'linear-gradient(135deg, rgba(139, 92, 246, 0.12), rgba(236, 72, 153, 0.06))'
                            ...
                            <div style={{ flex: 1 }}>
                                ...
                                <AppText as="p" style={{ margin: '6px 0 12px', fontSize: '0.85rem', lineHeight: 1.45 }}>
                                    {t(
                  'enable_push_desc',
              ...
              'This iPhone already allows notifications. Turn on the switch below to register this device.'
                    ...
                    <div className="setting-item">
                        <div className="setting-info">
                            ...
                            <div>
                                <AppText as="h4">{t('push_notifications', 'Push Notifications')}</AppText>
                                <AppText as="p">{t('push_notifications_desc', 'Alerts on this device when the app is closed')}</AppText>
                            </div>
                        </div>
            ...
            wordBreak: 'break-all'
                    ...
                    <div className="setting-item">
                        <div className="setting-info">
                            ...
                            <div>
                                <AppText as="h4">{t('email_notifications', 'Email Notifications')}</AppText>
                                <AppText as="p">{t('email_notifications_desc', 'Receive notifications via email')}</AppText>
                            </div>
                        </div>
                        <label className="toggle-switch">
                            <input
                ...
                onChange={(e) => setSettings({ ...settings, emailEnabled: e.target.checked })} />
                    ...
                    <div className="setting-item">
                        <div className="setting-info">
                            ...
                            <div>
                                <AppText as="h4">{t('sound', 'Sound')}</AppText>
                                <AppText as="p">{t('sound_desc', 'Play sound for notifications')}</AppText>
                            </div>
                        </div>
                        <label className="toggle-switch">
                            <input
                ...
                onChange={(e) => setSettings({ ...settings, soundEnabled: e.target.checked })} />
                    ...
                    <div className="setting-item">
                        <div className="setting-info">
                            ...
                            <div>
                                <AppText as="h4">{t('vibration', 'Vibration')}</AppText>
                                <AppText as="p">{t('vibration_desc', 'Vibrate for notifications')}</AppText>
                            </div>
                        </div>
                        <label className="toggle-switch">
                            <input
        ...
        <div className="settings-section">
          ...
          <div key={type.id} className="setting-item type-item">
                                <div className="setting-info">
                                    ...
                                    <AppText as="span">{type.label}</AppText>
                                </div>
                ...
                <div className="settings-section">
                    ...
                    <div className="setting-item">
                        <div className="setting-info">
                            ...
                            <div>
                                <AppText as="h4">{t('enable_dnd', 'Enable Do Not Disturb')}</AppText>
                                <AppText as="p">{t('dnd_desc', 'Silence notifications during specific hours')}</AppText>
                            </div>
                        </div>
                        <label className="toggle-switch">
                            <input
