      ...
      color: 'var(--text-main)'
        ...
        backdropFilter: 'blur(10px)'
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                    ...
                    <AppText as="h1" style={{ margin: 0, fontSize: '1.5rem', fontWeight: 800, background: 'linear-gradient(to right, var(--text-main), var(--text-muted))', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
                        DineBuddies
                    </AppText>
                </div>
        ...
        textAlign: 'center'
          ...
          backdropFilter: 'blur(10px)'
            ...
            lineHeight: 1.2
                        ...
                        <AppText as="span" style={{ color: 'var(--primary)' }}>
