        ...
        style={{
            ...
            <>
                ...
                flexDirection: 'column'
                                    ...
                                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
                                        <AppText as="span" style={{ fontSize: '0.9rem', fontWeight: 'bold' }}>{t('quick_emojis', 'Quick Emojis')}</AppText>
                                        <button
                    onClick={() => setShowEmojiPicker(false)}
          ...
          gap: '16px'
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '12px', width: '100%' }}>
                        <AppText as="span" style={{ fontSize: '0.85rem', fontWeight: '600', color: 'var(--text-main)', minWidth: '40px' }}>{t('size', 'Size')}</AppText>
                        <input
              type="range" min="12" max="48" value={fontSize}
              onChange={(e) => setFontSize(parseInt(e.target.value))}
              style={{ flex: 1, accentColor: 'var(--primary)' }} />

                        <AppText as="span" style={{ fontSize: '0.9rem', color: 'var(--text-main)', minWidth: '40px', textAlign: 'right', fontWeight: '600' }}>{fontSize}px</AppText>
                    </div>
