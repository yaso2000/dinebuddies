...
import {
  ...
  parseGoogleAddressComponents } from
        ...
        style={{
          ...
          style={{
            ...
            borderBottom: '1px solid var(--border-color)'
                    ...
                    <AppText as="h1" style={{ margin: 0, fontSize: '1.35rem', fontWeight: 900, color: 'var(--text-main)' }}>
                        {t('business_onboarding_title', 'Complete your business listing')}
                    </AppText>
                    <AppText as="p" style={{ margin: '0.5rem 0 0', fontSize: '0.88rem', color: 'var(--text-muted)', lineHeight: 1.5 }}>
                        {t(
            ...
            style={{
              ...
              style={{
                ...
                background: 'rgba(139, 92, 246, 0.06)'
                        ...
                        <AppText as="p" style={{ fontSize: '0.72rem', color: 'var(--text-muted)', margin: '0.45rem 0 0', lineHeight: 1.45 }}>
              ...
              style={{
                ...
                borderTop: '1px solid var(--border-color)'
                            ...
                            <AppText as="h3" style={{ fontSize: '0.95rem', fontWeight: 800, margin: '0 0 0.5rem', color: 'var(--text-main)' }}>
                                {t('business_onboarding_location_section', 'Find your business on Google Maps')}
                            </AppText>
                            <AppText as="p" style={{ fontSize: '0.78rem', color: 'var(--text-muted)', margin: '0 0 0.65rem', lineHeight: 1.45 }}>
                                {t(
            ...
            style={{
              ...
              background: 'var(--bg-body)'
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: '0.5rem' }}>
                                ...
                                <AppText as="h3" style={{ margin: 0, fontSize: '0.92rem', fontWeight: 800, color: 'var(--text-main)' }}>
                                    {t('business_onboarding_hours_imported', 'Opening hours (from Google)')}
                                </AppText>
                            </div>
                            <AppText as="p" style={{ margin: '0 0 0.65rem', fontSize: '0.76rem', color: 'var(--text-muted)', lineHeight: 1.45 }}>
                                {t(
                ...
                <div
                  style={{
                    ...
                    marginBottom: 6
                                        ...
                                        <AppText as="span">{formData.phone.trim()}</AppText>
                                    </div> :
                null}
                ...
                <div
                  style={{
                    ...
                    wordBreak: 'break-all'
                                        ...
                                        <AppText as="span">{formData.website.trim()}</AppText>
                                    </div> :
                null}
