    ...
    <div
      ...
      <div onClick={closeHeaderPreview} style={{ position: 'fixed', inset: 0, zIndex: 9999, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            ...
            style={{
              ...
              objectPosition: 'center'
                                ...
                                <div className="business-hero-start-row">
                                    <div className="business-hero-social">
                                        <div className="business-hero-action-col">
                                            ...
                                            <AppText as="span" style={{ fontSize: '0.8rem', fontWeight: '900', color: 'white', textShadow: '0 2px 4px rgba(0,0,0,0.9)' }}>
                ...
                <button type="button" onClick={(e) => {e.stopPropagation();navigate('/rankings');}} style={{ background: 'rgba(0,0,0,0.5)', border: '1px solid rgba(255,215,0,0.4)', borderRadius: '20px', padding: '4px 10px', display: 'flex', alignItems: 'center', gap: '6px', cursor: 'pointer', backdropFilter: 'blur(8px)', boxShadow: '0 2px 8px rgba(0,0,0,0.5)' }}>
                                        ...
                                        <AppText as="span" style={{ fontSize: '0.85rem', fontWeight: '900', color: 'white', textShadow: '0 1px 2px rgba(0,0,0,0.8)' }}>
                                            #{rankingPosition}
                                        </AppText>
                                    </button>
                }
        ...
        <div className="profile-section-content">
            ...
            position: 'relative', overflow: 'hidden'
                            ...
                            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '12px' }}>
                                <AppText as="h3" className="profile-section-header" style={{ fontSize: '1.3rem', margin: 0, display: 'flex', alignItems: 'center', gap: '8px' }}>
                                    <AppText as="span" style={{ fontSize: '1.5rem' }}>📄</AppText> {t('about_us', 'About Us')}
                                </AppText>
                                {isOwner &&
          ...
          <div style={{ marginTop: 'var(--profile-stack-gap)', marginBottom: '8px', background: 'var(--bg-card)', borderRadius: '16px', padding: '16px', border: '1px solid var(--border-color)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '16px', flexWrap: 'wrap' }}>
                            <div>
                                <AppText as="h3" style={{ margin: '0 0 4px 0', fontSize: '1.1rem', fontWeight: '800', color: 'var(--text-main)' }}>{t('feedback_box', 'Feedback & Complaints')}</AppText>
                                <AppText as="p" style={{ margin: 0, fontSize: '0.85rem', color: 'var(--text-secondary)' }}>{t('feedback_desc', 'Have a complaint or suggestion? Contact the management directly and privately.')}</AppText>
                            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--profile-stack-gap)', marginTop: 'var(--profile-stack-gap)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                        <AppText as="h3" style={{ margin: 0, fontSize: '1.2rem', fontWeight: '900', color: 'var(--text-main)' }}>{typeof t('offers', 'Offers') === 'string' ? t('offers', 'Offers') : 'Offers'}</AppText>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                        <AppText as="h3" style={{ margin: 0, fontSize: '1.2rem', fontWeight: '900', color: 'var(--text-main)' }}>{typeof t('featured_posts', 'Featured Posts') === 'string' ? t('featured_posts', 'Featured Posts') : 'Featured Posts'}</AppText>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
                                        <AppText as="h3" style={{ margin: 0, fontSize: '1.2rem', fontWeight: '900', color: 'var(--text-main)' }}>{typeof t('events', 'Events') === 'string' ? t('events', 'Events') : 'Events'}</AppText>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--profile-stack-gap)' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', background: 'var(--bg-card)', border: `1px solid var(--border-color)`, borderRadius: '24px', padding: '16px 24px', boxShadow: '0 10px 30px rgba(0,0,0,0.15)' }}>
                            <AppText as="h3" style={{ fontSize: '1.1rem', fontWeight: '800', margin: 0, color: 'var(--text-main)', display: 'flex', alignItems: 'center', gap: '8px' }}>
                                <AppText as="span" style={{ fontSize: '1.2rem' }}>📞</AppText> {t('contact_information', 'Contact Information')}
                            </AppText>
                            {isOwner &&
            <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
                                    <PaidFeatureBadge />
