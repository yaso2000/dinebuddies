...
import {
  ...
  FaPlay, FaPause, FaTrash, FaArrowDown } from
'react-icons/fa';
      ...
      case 'shared_content':
        return (
          <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                        ...
                        {msg.text && <AppText as="span" dir="auto">{msg.text}</AppText>}
                    </div>);
            ...
            <UserAvatar
              ...
              style={{
                ...
                flexShrink: 0
                        ...
                        <AppText as="span" className="big-emoji" style={{ position: 'relative', zIndex: 2 }}>{msg.text}</AppText>
      ...
      case 'audio':
        ...
        return (
          <div className="voice-widget">
                ...
                <AppText as="span" className="play-shape"></AppText>
                }
                            </button>
                        </div>
                    </div>);
  ...
  if (!isMember) {
    return (
      <div className="chat-screen" style={{ justifyContent: 'center', alignItems: 'center', color: 'var(--text-primary)' }}>
                <AppText as="h2">{t("access_denied")}</AppText>
                <button onClick={() => navigate('/messages?tab=communities')} style={{ padding: '10px', marginTop: '10px' }}>{t("go_back")}</button>
            </div>);
    ...
    <div dir="ltr" ref={containerRef} className="chat-room-container chat-screen community-chat-root" style={{
      ...
      overflow: 'hidden'
            ...
            <header className="chat-header">
                <button className="header-back-btn" onClick={() => navigate('/messages?tab=communities')} style={{ color: 'var(--text-primary)' }}>
            ...
            style={{ width: '40px', height: '40px', minWidth: '40px', minHeight: '40px', maxWidth: '40px', maxHeight: '40px', flexShrink: 0, marginInlineEnd: '10px', objectFit: 'cover' }} />
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', flex: 1, minWidth: 0 }}>
                        <AppText as="h1" className="header-title" style={{ fontSize: '16px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%' }}>{partner?.display_name || t('community_chat')}</AppText>
                        <AppText as="span" className="header-subtitle" style={{ fontSize: '12px', whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis', width: '100%' }}>{partner?.communityMembers?.length || 0} {t("members")}</AppText>
                    </div>
                </div>
            ...
            return (
              <div
                ...
                <UserAvatar
                  ...
                  style={{
                    visibility: isFirstOfGroup ? 'visible' : 'hidden',
                  ...
                  <div style={{
                    ...
                    <AppText as="span" className="timestamp" style={{ margin: '0 0 0 auto', display: 'flex', flexShrink: 0, color: isMe ? 'rgba(255,255,255,0.7)' : 'var(--text-muted)' }}>
                  ...
                  <div className="message-reaction-badge">
                                        ...
                                        {reactions.length > 1 && <AppText as="span" style={{ marginInlineStart: '2px', color: '#9CA3AF' }}>{reactions.length}</AppText>}
                                    </div>
                  }
                            </div>
...
export default CommunityChatRoomLegacy;