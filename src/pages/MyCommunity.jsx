        ...
        aria-label={t('business_profile', 'Business profile')}>
            ...
            <div className="my-community-stats">
                <div className="my-community-stat-card ui-card">
                    ...
                    <AppText as="h4" style={{ fontSize: '1.5rem', fontWeight: '800', margin: '4px 0' }}>{stats.members}</AppText>
                    <AppText as="p" style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>{t('members', 'Members')}</AppText>
                </div>
                <div className="my-community-stat-card ui-card">
                    <FaEnvelope style={{ fontSize: '1.5rem', color: 'var(--primary)', marginBottom: '8px' }} />
                    <AppText as="h4" style={{ fontSize: '1.5rem', fontWeight: '800', margin: '4px 0' }}>{stats.invitations}</AppText>
                    <AppText as="p" style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>{t('invitations', 'Invitations')}</AppText>
                </div>
                <div className="my-community-stat-card ui-card" title={t('engagement_tooltip', 'Likes and comments on your community posts')}>
                    ...
                    <AppText as="h4" style={{ fontSize: '1.5rem', fontWeight: '800', margin: '4px 0' }}>{stats.engagement}</AppText>
                    <AppText as="p" style={{ fontSize: '0.75rem', color: 'var(--text-muted)', margin: 0 }}>{t('engagement', 'Engagement')}</AppText>
                    <AppText as="p" style={{ fontSize: '0.65rem', color: 'var(--text-muted)', margin: '2px 0 0', opacity: 0.9 }}>{t('engagement_hint', 'Likes + comments')}</AppText>
                </div>
            </div>
