    ...
    <div
      ...
      <>
                    ...
                    <section style={{ marginBottom: '2rem', padding: '1rem 1.25rem', border: '2px solid var(--primary)', borderRadius: 12 }}>
                        ...
                        <AppText as="p">يطبّق DineBuddies سياسة <strong>عدم تسامح مطلقة مع المحتوى المسيء والمستخدمين المسيئين</strong>. تشمل كل المحتوى الذي ينشئه المستخدمون — البروفايلات والصور والرسائل والدعوات وكل ميزة اجتماعية.</AppText>
                        ...
                        <ul style={listStyle(isAr)}>
                            ...
                            <li>زر <strong>إبلاغ</strong> على البروفايلات والرسائل وكل محتوى مُشارَك.</li>
      ...
      <>
                    ...
                    <section style={{ marginBottom: '2rem', padding: '1rem 1.25rem', border: '2px solid var(--primary)', borderRadius: 12 }}>
                        ...
                        <AppText as="p">DineBuddies has a strict <strong>zero-tolerance policy for objectionable content and abusive users</strong>. This applies to all user-generated content — profiles, photos, messages, invitations, and every social feature.</AppText>
                        ...
                        <ul style={listStyle(isAr)}>
                            ...
                            <li>A <strong>Report</strong> control on profiles, messages, and all shared content.</li>
