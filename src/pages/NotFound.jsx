    ...
    <div
      ...
      style={{
        ...
        gap: 16
            ...
            <AppText as="h1" style={{ fontSize: '1.35rem', fontWeight: 800, margin: 0 }}>
                {t('page_not_found_title', 'Page not found')}
            </AppText>
            <AppText as="p" style={{ margin: 0, maxWidth: 420, color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.5 }}>
                {t(
          'page_not_found_hint',
