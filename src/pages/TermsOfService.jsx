    ...
    <div
      ...
      <>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        <AppText as="p"><strong>9.3 محفظة الادخار والهدايا.</strong> قد تُضاف إلى محفظة الادخار (تُعرض للمستخدم باسم "كرزات") نسبة من قيمة الهدايا المستلمة (حالياً 30٪ من المبلغ المرسل، قابلة للتغيير). يمكن إنفاق رصيد الادخار على خدمات داخلية وفق قواعد الخصم المعتمدة (الشراء أولاً ثم الادخار). شارات التقدّم البصرية (إن وُجدت) للمتعة داخل التطبيق فقط وليست مقابل نقد.</AppText>
                        ...
                        {cashoutEnabled ? (
                          <>
                            <AppText as="p"><strong>9.4أ السحب النقدي بحزم البرطمانات (مفعّل).</strong> عند تفعيل البرنامج، يتم السحب فقط باستبدال حزمة برطمان ثابتة معلنة داخل التطبيق (بحجم واحد أو أكثر ضمن طلب واحد)، شريطة كفاية رصيد الادخار. كريدت الشراء غير قابل للسحب.</AppText>
                          </>
                        ) : null}
      ...
      <>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        ...
                        {cashoutEnabled ? (
                          <AppText as="p"><strong>9.4a Jar cash-out (enabled).</strong> When the program is enabled, redemption is only via fixed Jar packages announced in the Service (one or more sizes per request), from savings balance only. Purchased credits remain non-withdrawable.</AppText>
                        ) : null}
