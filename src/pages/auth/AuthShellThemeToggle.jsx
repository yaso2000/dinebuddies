...
/** Day/night toggle for login and other full-page auth shells. */import { AppText } from "../../components/base";
  ...
  return (
    <button
      ...
      title={label}>
            ...
            {!isCorner ? <AppText as="span" className="auth-shell-theme-toggle__label">{label}</AppText> : null}
        </button>);
