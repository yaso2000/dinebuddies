        ...
        <div style={{ padding: '20px', paddingBottom: '100px', color: 'var(--text-main)', maxWidth: '900px', margin: '0 auto', textAlign: i18n.language === 'ar' ? 'right' : 'left', lineHeight: '1.6' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '15px', marginBottom: '40px', borderBottom: '1px solid var(--border-color)', paddingBottom: '20px' }}>
                ...
                <div>
                    ...
                    <p style={{ margin: 0, opacity: 0.6 }}>We care about your privacy and data protection</p>
                </div>
            </div>

            <section style={{ marginBottom: '40px' }}>
                <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--primary)' }}>
                    <FaEye /> 1. Information We Collect
                </h3>
            ...
            <section style={{ marginBottom: '40px' }}>
                <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--primary)' }}>
                    <FaUserLock /> 2. How We Use Your Information
                </h3>
                <div style={{ padding: '0 10px' }}>
                    <p>We use your data for the following purposes:</p>
                    <ul>
                        <li>Facilitating your communication with other users based on shared interests.</li>
                        <li>Improving service quality and personalizing the user experience.</li>
                        <li>Sending notifications related to join requests and chat updates.</li>
                        <li>Protecting accounts from fraudulent activities and breaches.</li>
                    </ul>
                </div>
            </section>
            ...
            <section style={{ marginBottom: '40px' }}>
                <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--primary)' }}>
                    <FaDatabase /> 3. Sharing Data with Third Parties
                </h3>
                <div style={{ padding: '0 10px' }}>
                    <p>
            ...
            <section style={{ marginBottom: '40px' }}>
                <h3 style={{ display: 'flex', alignItems: 'center', gap: '10px', color: 'var(--primary)' }}>
                    <FaTrashAlt /> 4. Your Rights and Data Deletion
                </h3>
                <div style={{ padding: '0 10px' }}>
                    <p>
            ...
            <div style={{ marginTop: '50px', padding: '25px', background: 'var(--bg-card)', borderRadius: '20px', border: '1px solid var(--border-color)', boxShadow: '0 10px 30px rgba(0,0,0,0.05)' }}>
                <h4 style={{ margin: '0 0 10px 0', color: 'var(--primary)' }}>Contact Us</h4>
