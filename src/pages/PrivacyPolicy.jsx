    ...
    <div
      style={{
        ...
        boxSizing: 'border-box'
            ...
            {isAr ?
      <>
                    <AppText as="p" style={{ marginBottom: '1.5rem' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>2. المعلومات التي نجمعها</AppText>
                        <AppText as="p">نحن نجمع المعلومات بعدة طرق.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.1 المعلومات التي تقدمها</AppText>
                        <AppText as="p">عند إنشاء حساب أو استخدامه، قد تقدم:</AppText>
                        ...
                        <AppText as="p">تسمح هذه المعلومات للمنصة بالعمل وتمكين التفاعل الاجتماعي بين المستخدمين.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.2 معلومات الملف الشخصي والأعمال</AppText>
                        <AppText as="p">قد توفر حسابات الأعمال معلومات إضافية بما في ذلك:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                            <li>اسم العمل</li>
                            <li>وصف العمل</li>
                        ...
                        <AppText as="p">يمكن تعطيل خدمات الموقع في أي وقت من إعدادات الجهاز.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.4 محتوى المستخدم</AppText>
                        <AppText as="p">قد يقوم المستخدمون بإنشاء ومشاركة المحتوى بما في ذلك:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                        ...
                        <AppText as="p">قد يكون المحتوى مرئيًا للمستخدمين الآخرين وفقًا لإعدادات الخصوصية.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.5 الأجهزة والمعلومات الفنية</AppText>
                        <AppText as="p">قد نقوم تلقائيًا بجمع معلومات تقنية معينة بما في ذلك:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                            <li>نوع الجهاز</li>
                            <li>نظام التشغيل</li>
                            <li>نوع المتصفح</li>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>3. الخدمات وتقنيات الجهات الخارجية</AppText>
                        <AppText as="p">قد تستخدم الخدمة تقنيات الجهات الخارجية التي تعالج معلومات معينة.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>3.1 فايربيس (Google)</AppText>
                        <AppText as="p">تستخدم DineBuddies خدمات Firebase، والتي قد تشمل:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>4. كيف نستخدم المعلومات الشخصية</AppText>
                        <AppText as="p">قد نستخدم المعلومات التي تم جمعها في:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                        ...
                        <AppText as="p">قد نستخدم أيضاً بيانات مجمعة للتحليل الإحصائي.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>5. الأساس القانوني للمعالجة (GDPR)</AppText>
                        <AppText as="p">بالنسبة للمستخدمين المقيمين في المنطقة الاقتصادية الأوروبية (EEA)، نقوم بمعالجة البيانات الشخصية بموجب الأسس القانونية التالية:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>6. تبادل المعلومات</AppText>
                        <AppText as="p">نحن لا نبيع البيانات الشخصية.</AppText>
                        <AppText as="p">قد يتم مشاركة المعلومات في الحالات التالية:</AppText>
                        <AppText as="p"><strong>مع مستخدمين آخرين:</strong> قد تكون بعض معلومات الملف الشخصي مرئية للمستخدمين الآخرين بما في ذلك اسم العرض، وصورة الملف الشخصي، والدعوات، وملفات الأنشطة التجارية.</AppText>
                        <AppText as="p"><strong>مع مزودي الخدمة:</strong> قد نشارك البيانات مع مزودي الخدمة الموثوقين الذين يدعمون المنصة، بما في ذلك الاستضافة السحابية والتحليلات وخدمات المراسلة.</AppText>
                        <AppText as="p"><strong>الامتثال القانوني:</strong> قد نكشف عن معلومات عندما يُطلب منا الامتثال للقوانين أو الإجراءات القانونية، أو الاستجابة لطلبات إنفاذ القانون، أو لحماية سلامة المستخدم أو سلامة المنصة.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>7. أمان البيانات</AppText>
                        <AppText as="p">نُطبق تدابير فنية وتنظيمية معقولة لحماية البيانات الشخصية، بما في ذلك:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                        ...
                        <AppText as="p">ومع ذلك، لا يمكن لأي نظام متصل بالإنترنت ضمان الأمن المطلق.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>8. الاحتفاظ بالبيانات</AppText>
                        <AppText as="p">نحن نحتفظ بالمعلومات الشخصية فقط طالما كان ذلك ضروريًا من أجل:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                            <li>تقديم الخدمة</li>
                        ...
                        <AppText as="p">قد تبقى الحسابات المحذوفة في النسخ الاحتياطية لفترة محدودة.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>9. حقوقك (GDPR)</AppText>
                        <AppText as="p">قد يتمتع المستخدمون المقيمون في الاتحاد الأوروبي بالحقوق التالية:</AppText>
                        <ul style={{ paddingLeft: '0', paddingRight: '1.5rem' }}>
                        ...
                        <AppText as="p">يمكن إرسال الطلبات إلى بريدنا الإلكتروني الخاص بالاتصال.</AppText>
                    </section>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>12. عمليات نقل البيانات الدولية</AppText>
                        <AppText as="p">نظرًا لأن بنيتنا التحتية قد تستخدم مزودي خدمات سحابية عالميين، فقد يتم معالجة معلومات المستخدم في بلدان خارج بلد إقامة المستخدم. نحن نتخذ ضمانات مناسبة لضمان عمليات النقل القانونية.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>13. التغييرات على سياسة الخصوصية هذه</AppText>
                        <AppText as="p">قد نقوم بتحديث سياسة الخصوصية هذه من وقت لآخر. عند حدوث تغييرات، ستُنشر السياسة المحدثة في هذه الصفحة، وسيتم تحديث تاريخ "آخر تحديث"، ويُعد استمرارك في استخدام الخدمة موافقة على السياسة المنقحة.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>14. اتصل بنا</AppText>
                        <AppText as="p">إذا كانت لديك أسئلة حول سياسة الخصوصية هذه، فاتصل بنا على:</AppText>
                        <AppText as="p"><strong>{t('email', 'Email')}:</strong> support@dinebuddies.com</AppText>
      ...
      <>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>2. Information We Collect</AppText>
                        <AppText as="p">We collect information in several ways.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.1 Information You Provide</AppText>
                        <AppText as="p">When you create or use an account, you may provide:</AppText>
                        ...
                        <AppText as="p">This information allows the platform to function and enables social interaction between users.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.2 Profile and Business Information</AppText>
                        <AppText as="p">Business accounts may provide additional information including:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                            <li>Business name</li>
                        ...
                        <AppText as="p">Location services can be disabled at any time in device settings.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.4 User Content</AppText>
                        <AppText as="p">Users may create and share content including:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                        ...
                        <AppText as="p">Content may be visible to other users depending on privacy settings.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>2.5 Device and Technical Information</AppText>
                        <AppText as="p">We may automatically collect certain technical information including:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                            <li>Device type</li>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>3. Services and Third-Party Technologies</AppText>
                        <AppText as="p">The Service may use third-party technologies that process certain information.</AppText>

                        <AppText as="h3" style={{ fontSize: '1.1rem', marginTop: '1.25rem', marginBottom: '0.5rem' }}>3.1 Firebase (Google)</AppText>
                        <AppText as="p">DineBuddies uses Firebase services, which may include:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>4. How We Use Personal Information</AppText>
                        <AppText as="p">We may use collected information to:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                        ...
                        <AppText as="p">We may also use aggregated data for statistical analysis.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>5. Legal Basis for Processing (GDPR)</AppText>
                        <AppText as="p">For users located in the European Economic Area (EEA), we process personal data under the following legal bases:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>6. Sharing of Information</AppText>
                        <AppText as="p">We do not sell personal data.</AppText>
                        <AppText as="p">Information may be shared in the following situations:</AppText>
                        <AppText as="p"><strong>With Other Users:</strong> Certain profile information may be visible to other users including display name, profile photo, invitations, and business profiles.</AppText>
                        <AppText as="p"><strong>With Service Providers:</strong> We may share data with trusted service providers that support the platform, including cloud hosting, analytics, and messaging services.</AppText>
                        <AppText as="p"><strong>Legal Compliance:</strong> We may disclose information when required to comply with laws or legal processes, respond to law enforcement requests, or protect user safety or platform integrity.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>7. Data Security</AppText>
                        <AppText as="p">We implement reasonable technical and organizational measures to protect personal data, including:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                        ...
                        <AppText as="p">However, no online system can guarantee absolute security.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>8. Data Retention</AppText>
                        <AppText as="p">We retain personal information only as long as necessary to:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                        ...
                        <AppText as="p">Deleted accounts may remain in backups for a limited period.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>9. Your Rights (GDPR)</AppText>
                        <AppText as="p">Users located in the European Union may have the following rights:</AppText>
                        <ul style={{ paddingLeft: '1.5rem', paddingRight: '0' }}>
                        ...
                        <AppText as="p">Requests can be sent to our contact email.</AppText>
                    </section>
                    ...
                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>12. International Data Transfers</AppText>
                        <AppText as="p">Because our infrastructure may use global cloud providers, user information may be processed in countries outside the user's country of residence. We take appropriate safeguards to ensure lawful transfers.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>13. Changes to This Privacy Policy</AppText>
                        <AppText as="p">We may update this Privacy Policy from time to time. When changes occur, the updated policy will be posted on this page, the "Last Updated" date will be updated, and continued use of the Service indicates acceptance of the revised policy.</AppText>
                    </section>

                    <section style={{ marginBottom: '2rem' }}>
                        <AppText as="h2" style={{ fontSize: '1.35rem', color: 'var(--primary)', marginBottom: '0.75rem' }}>14. Contact Us</AppText>
                        <AppText as="p">If you have questions about this Privacy Policy, contact us at:</AppText>
                        <AppText as="p"><strong>{t('email', 'Email')}:</strong> support@dinebuddies.com</AppText>
                        <AppText as="p"><strong>{t('website', 'Website')}:</strong> https://dinebuddies.com</AppText>
                    </section>
                </>
