...
const AuthActionHandler = () => {
        ...
        return (
            <div style={{
                ...
                <div style={{ textAlign: 'center' }}>
                    ...
                    <p style={{ fontSize: '0.95rem' }}>Confirming your email…</p>
                </div>
            </div>
        );
    }
    ...
    if (status === 'resetPassword') {
        return (
            <div style={{
                ...
                >
                    <h1 style={{ fontSize: '1.25rem', margin: '0 0 0.5rem', fontWeight: 700 }}>Set a new password</h1>
                    ...
                    />
                    {message ? (
                        <p style={{ color: '#f87171', fontSize: '0.88rem', marginBottom: '0.75rem' }}>{message}</p>
                    ) : null}
                    <button
                        type="submit"
                        disabled={submitting}
        ...
        return (
            <div style={{
                ...
                <div style={{
                    ...
                    <p style={{ marginBottom: '1rem', fontSize: '0.95rem' }}>{message}</p>
                    <button
                        type="button"
    ...
    return (
        <div style={{
            ...
            <div style={{ textAlign: 'center' }}>
                <div className="spinner" style={{ margin: '0 auto 1rem' }} />
                <p style={{ fontSize: '0.95rem' }}>Redirecting…</p>
            </div>
        </div>
    );
};
