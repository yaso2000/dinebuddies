        ...
        fontFamily: 'var(--font-body)'
            ...
            <div style={{ maxWidth: '560px', margin: '0 auto' }}>
                <div style={{ textAlign: 'center', marginBottom: '1.5rem', color: 'var(--text-main)' }}>
                    <AppText as="h1" style={{ fontSize: '2.5rem', fontWeight: '900', marginBottom: '0.5rem' }}>
                        {t('credits_pricing_page_title', 'Credits & add-ons')}
                    </AppText>
                    <AppText as="p" style={{ fontSize: '1.1rem', color: 'var(--text-muted)', lineHeight: 1.55 }}>
                        {t(
          ...
          style={{
            ...
            border: '1px solid var(--border-color)'
                    ...
                    <AppText as="h2" style={{ color: 'var(--text-main)', fontSize: '1.5rem', fontWeight: '900', marginBottom: '0.75rem' }}>
                        {t('dine_credits_wallet_card_title', 'Dine Credits wallet')}
                    </AppText>
                    <AppText as="p" style={{ color: 'var(--text-muted)', fontSize: '0.95rem', lineHeight: 1.55, marginBottom: '1.25rem' }}>
                        {t(
              'dine_credits_wallet_card_body',
              'Buy credit packs in one place. The same balance covers private invitations, private invites, AI tools, and other in-app features.'
            )}
                    </AppText>
                    <button
            type="button"
