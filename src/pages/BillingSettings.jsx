            ...
            border: '1px solid var(--border-color)'
              ...
              marginBottom: '1rem'
                ...
                fontSize: '0.9rem'
                                    ...
                                    <AppText as="span" style={{ color: 'var(--text-secondary)' }}>
                                        Total Invoices:
                                    </AppText>
                                    <AppText as="span" style={{ color: 'var(--text-main)', fontWeight: '600' }}>
                                        {invoices.length}
                                    </AppText>
                                </div>
                                <div style={{
                ...
                fontSize: '0.9rem'
                                    ...
                                    <AppText as="span" style={{ color: '#10b981', fontWeight: '700' }}>
