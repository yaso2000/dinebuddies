      ...
      <div className="affiliate-shell">
                <div className="affiliate-dash">
                    <div className="affiliate-card" style={{ textAlign: 'center', padding: '2rem' }}>
                        <AppText as="h2">{t('affiliate_account_banned', 'Account suspended')}</AppText>
  ...
  if (userProfile?.frozen === true) {
    return (
      <div className="affiliate-shell">
                <div className="affiliate-dash">
                    <div className="affiliate-card" style={{ textAlign: 'center', padding: '2rem' }}>
                        <AppText as="h2">{t('affiliate_dashboard_frozen', 'Dashboard access paused')}</AppText>
                        <AppText as="p" className="affiliate-sub">
                            {t(
    ...
    <div className="affiliate-shell">
        ...
        <div
          ...
          style={{
            ...
            background: 'rgba(234, 179, 8, 0.08)'
                        ...
                        <AppText as="p" className="affiliate-muted" style={{ margin: '8px 0 12px' }}>
                            {t(
        ...
        null}
          ...
          style={{ marginBottom: 20 }}>
                    ...
                    <AppText as="h2" id="affiliate-dash-payout-title" style={{ margin: '0 0 8px', fontSize: '1.05rem', fontWeight: 800 }}>
                        {t('affiliate_dash_payout_title', 'Payout & mailing details')}
                    </AppText>
                    <AppText as="p" className="affiliate-muted" style={{ margin: '0 0 14px' }}>
                        {t(
              ...
              'PayPal and your address are required before withdrawals can be processed. You can edit them anytime.'
                ...
                t('affiliate_dash_address_missing', 'Not set — add in Settings')}
                    ...
                    {!payoutBasicsOk ?
          <AppText as="p" className="affiliate-muted" style={{ margin: '12px 0 0', fontSize: '0.82rem' }}>
                            {t(
          ...
          null}
            ...
            null}
                ...
                <section className="affiliate-marketing" aria-labelledby="affiliate-marketing-title">
                    <AppText as="h2" id="affiliate-marketing-title">{t('affiliate_marketing_title', 'Your referral link')}</AppText>
                    <AppText as="p" className="affiliate-marketing-p">
                        {t(
          ...
          <AppText as="p" className="affiliate-muted" style={{ marginBottom: 12 }}>
              ...
              aria-label={t('affiliate_referral_url', 'Referral URL')} />
                    ...
                    <AppText as="p" className="affiliate-muted" style={{ margin: '0 0 10px', fontSize: '0.78rem', fontWeight: 700 }}>
            ...
            null}
              ...
              onClick={(e) => {
                ...
                <section aria-labelledby="affiliate-activity-title">
                    <AppText as="h2" id="affiliate-activity-title" style={{ fontSize: '1.05rem', fontWeight: 800, margin: '0 0 12px' }}>
