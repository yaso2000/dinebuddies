...
/** Avoid false "not an affiliate" right after auth: local cache can lag behind `users/{uid}` on the server. */import { AppText, AppTextInput } from "../../components/base";
  ...
  return (
    <AffiliateAuthShell>
            <div className="affiliate-card affiliate-auth-card" style={{ maxWidth: 420, width: '100%', margin: '0 auto' }}>
                <AppText as="h1" className="affiliate-h1">{t('affiliate_login_title', 'Affiliate sign-in')}</AppText>
                <AppText as="p" className="affiliate-muted" style={{ marginBottom: 20 }}>
