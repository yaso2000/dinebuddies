...
export default function SmartSenderPage() {
  ...
  return (
    <>
            <AppText as="h1" className="db-h1">{t('admin_sender_title')}</AppText>
            <AppText as="p" className="db-lead">{t('admin_sender_lead')}</AppText>
        ...
        maxLength={4000} />
            ...
            disabled={sending}>
                    ...
                    <AppText as="span" className="db-muted">{message.length}/4000</AppText>
                </div>

                {status && <AppText as="p" className="db-status-msg">{status}</AppText>}
            </div>

            <AppText as="h2" className="db-h2">{t('admin_sender_campaign_history')}</AppText>
        ...
        <table className="db-table">
            ...
            <tr key={row.id}>
                                    ...
                                    <td>
                                        {row.sentCount}
                                        {row.failedCount > 0 &&
                <AppText as="span" className="db-badge db-badge--warn" style={{ marginInlineStart: 6 }}>
