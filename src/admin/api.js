...
export const adminApi = {
    ...
    listSupportTickets: (opts = {}) => call('adminListSupportTickets', opts),
    replySupportTicket: (ticketId, message) => call('adminReplySupportTicket', { ticketId, message }),
    setSupportTicketStatus: (ticketId, status) => call('adminSetSupportTicketStatus', { ticketId, status }),
