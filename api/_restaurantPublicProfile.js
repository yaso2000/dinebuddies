...
export function buildPublicProfileFromRestaurant(restaurantId, data) {
    ...
    return {
        ...
        businessPublic: {
            ...
            bioSource: bi.bioSource || null,
            coverImage: coverImage || null,
            coverImageStoragePath:
                String(data.coverImageStoragePath || bi.coverImageStoragePath || '').trim() || null,
            gallery: Array.isArray(bi.gallery) ? bi.gallery : [],
            lat,
            lng,
            phone: bi.phone || data?.phone || null,
            website: bi.website || data?.website || null,
            googleMapsUri: bi.googleMapsUri || null,
            priceLevel: bi.priceLevel || null,
            googlePlaceRating: typeof bi.googlePlaceRating === 'number' ? bi.googlePlaceRating : null,
            userRatingCount: typeof bi.userRatingCount === 'number' ? bi.userRatingCount : null,
            serviceFlags: bi.serviceFlags || null,
            hours,
            openingHours,
            openNow,
