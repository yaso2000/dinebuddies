...
/**
 * Build Gemini personalization context for dating invitation text.
 *
 * @param {import('firebase-admin/firestore').Firestore} db
 ...
 * }} input
 */
export async function resolveDatingInvitationPersonalization(db, hostUid, hostUserData, input) {
