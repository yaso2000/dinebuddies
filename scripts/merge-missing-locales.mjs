...
const arAdd = JSON.parse(fs.readFileSync(path.join(__dirname, 'locale-ar-missing-144.json'), 'utf8'));
const enAdd = JSON.parse(fs.readFileSync(path.join(__dirname, 'locale-en-missing-144.json'), 'utf8'));
